...
|---|---|---|
| `content/` | The published instruction set — 24 markdown files served as `agents://` resources. | You are changing a convention every repository follows. **This is a release.** |
